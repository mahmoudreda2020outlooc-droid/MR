...
const translations = {
    en: {
        ...
        project4_description: "A premium, high-performance portfolio website showcasing creative web development projects with a focus on modern UI/UX and multi-language support.",
        project4_feature1: "Multi-language Support: Seamless switching between English, Arabic, and French.",
        project4_feature2: "Interactive 3D Effects: Smooth tilt animations on cards and interactive hero visuals.",
        project4_feature3: "Project Portal: A system for clients to start and track their project status in real-time.",
        project4_feature4: "Performance Optimized: High Lighthouse scores ensuring fast loading and SEO friendliness.",
        project4_feature5: "Modern Design: Glassmorphism, smooth gradients, and sophisticated typography.",
    ...
    ar: {
        ...
        project4_title: "موقع بورتفوليو الشخصي",
        project4_description: "موقع تعريفي احترافي عالي الأداء يعرض مشاريع تطوير الويب الإبداعية مع التركيز على واجهة وتجربة مستخدم حديثة ودعم لغات متعددة.",
        project4_feature1: "دعم لغات متعددة: تبديل سلس بين العربية والإنجليزية والفرنسية.",
        project4_feature2: "تأثيرات ثلاثية الأبعاد: انيميشن تفاعلي للبطاقات وعناصر القسم الرئيسي.",
        project4_feature3: "بوابة المشاريع: نظام للعملاء لبدء وتتبع حالة مشاريعهم لحظياً.",
        project4_feature4: "أداء فائق: سرعة تحميل عالية وصداقة لمحركات البحث (SEO).",
        project4_feature5: "تصميم عصري: استخدام الـ Glassmorphism والتدرجات اللونية الجذابة.",
    ...
    fr: {
        ...
        project4_title: "Site Portfolio Personnel",
        project4_description: "Un site portfolio moderne et performant présentant des projets de développement web créatifs avec un focus sur l'UI/UX et le support multilingue.",
        project4_feature1: "Support Multilingue: Passage fluide entre l'anglais, l'arabe et le français.",
        project4_feature2: "Effets 3D Interactifs: Animations d'inclinaison fluides et visuels interactifs.",
        project4_feature3: "Portail Projet: Système permettant aux clients de lancer et suivre leurs projets en temps réel.",
        project4_feature4: "Optimisé pour la Performance: Temps de chargement rapides et optimisation SEO.",
        project4_feature5: "Design Moderne: Glassmorphism, dégradés lisses et typographie soignée.",
