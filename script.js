...
const translations = {
    en: {
        ...
        project4_title: "Graduation Project (Control Hub)",
        project4_description: "A comprehensive control hub built with a Premium UI and high performance, designed for real-time monitoring and management.",
        project4_feature1: "Tech Stack: Built with Next.js 15 & React 19 with TypeScript for fast Server-side Rendering and high code stability.",
        project4_feature2: "Premium UI/UX Design: Utilizes Glassmorphism with a Sleek Dark Mode for a futuristic feel, powered by Framer Motion for smooth animations and interactions.",
        project4_feature3: "Real-time Dashboard Concept: Interactive dashboard displaying simulated data for robot status, battery, and productivity, ready for real API integration.",
        project4_feature4: "Full Responsiveness: 100% compatible with mobile, tablet, and desktop screens, optimized for mobile UX.",
        project4_feature5: "Multi-language Support (i18n): Fully supports Arabic and English with seamless dynamic RTL layout switching.",
        project4_feature6: "Arabic Search Normalization: Advanced Arabic search processing handling different character forms (like Hamza and Ta' Marbuta) for optimal results.",
        project4_feature7: "Performance Optimized: Optimized images and assets for fast loading, using Lucide React for lightweight, high-res icons.",
        project4_feature8: "Interactive Elements: Features a custom Lightbox System for high-res images and a uniquely designed Vertical Quiz Card.",
    ...
    ar: {
        ...
        project4_title: "مشروع تخرج",
        project4_description: "الموقع ده تم بناؤه ليكون منصة تحكم متكاملة (Control Hub) بتصميم عصري (Premium UI) وأداء فائق.",
        project4_feature1: "Tech Stack: تم استخدام Next.js 15 & React 19 مع TypeScript لضمان أسرع أداء (Server-side Rendering) وأعلى استقرار للكود.",
        project4_feature2: "Premium UI/UX Design: الموقع بيستخدم جماليات Glassmorphism مع واجهة داكنة (Sleek Dark Mode) بتدي إيحاء بالمستقبل، مع استخدام مكتبة Framer Motion لعمل حركات (Smooth Animations) وتفاعلات مبهرة.",
        project4_feature3: "Real-time Dashboard Concept: لوحة تحكم تفاعلية بتعرض بيانات وهمية (Simulated Data) لحالة الروبوت، البطارية، والإنتاجية، مصممة لاستقبال بيانات حقيقية عبر الـ API.",
        project4_feature4: "Full Responsiveness: الموقع متوافق 100% مع كل شاشات الموبايل والتابلت والديسكتوب، مع تحسينات خاصة لتجربة المستخدم على الموبايل.",
        project4_feature5: "Multi-language Support (i18n): الموقع يدعم اللغتين العربية والإنجليزية بشكل كامل، مع دعم الـ RTL Layout (تغيير اتجاه الصفحة) بشكل ديناميكي وسلس جداً.",
        project4_feature6: "Arabic Search Normalization: إضافة جحدة، الموقع فيه نظام معالجة ذكي للبحث باللغة العربية، بيقدر يفهم الحروف بمختلف أشكالها (زي الهمزات والتاء المربوطة) عشان يضمن أفضل نتيجة بحث.",
        project4_feature7: "Performance Optimized: تم تحسين الصور والأصول (Assets) عشان الموقع يحمل في أسرع وقت، مع استخدام مكتبة Lucide React للأيقونات لتكون خفيفة وبدقة عالية.",
        project4_feature8: "Interactive Elements: الموقع فيه \"Lightbox System\" مخصص لعرض صور المشروع بدقة عالية، و \"Vertical Quiz Card\" بتصميم مميز جداً.",
    ...
    fr: {
        ...
        project4_title: "Projet de Fin d'Études",
        project4_description: "Une plateforme de contrôle complète construite avec une interface Premium et de hautes performances, conçue pour la surveillance en temps réel.",
        project4_feature1: "Tech Stack : Construit avec Next.js 15 & React 19 et TypeScript pour un rendu côté serveur rapide et une grande stabilité du code.",
        project4_feature2: "Design UI/UX Premium : Utilise le Glassmorphism avec un mode sombre élégant pour un rendu futuriste, animé par Framer Motion.",
        project4_feature3: "Concept de Tableau de Bord en Temps Réel : Tableau de bord interactif affichant des données simulées, prêt pour l'intégration API.",
        project4_feature4: "Entièrement Réactif : 100% compatible avec les écrans mobiles, tablettes et ordinateurs de bureau.",
        project4_feature5: "Support Multilingue (i18n) : Support complet de l'arabe et de l'anglais avec basculement dynamique RTL/LTR.",
        project4_feature6: "Normalisation de la Recherche Arabe : Traitement avancé de la recherche arabe gérant différentes formes de caractères.",
        project4_feature7: "Optimisé pour la Performance : Images optimisées et utilisation de Lucide React pour des icônes légères.",
        project4_feature8: "Éléments Interactifs : Dispose d'un système Lightbox personnalisé et d'une carte de quiz verticale unique.",
